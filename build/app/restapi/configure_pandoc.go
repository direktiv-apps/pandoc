...
//go:generate swagger generate server --target ../../app --name Pandoc --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/pandoc/build/templates --principal interface{}

func configureFlags(api *operations.PandocAPI) {
...
func configureAPI(api *operations.PandocAPI) http.Handler {
